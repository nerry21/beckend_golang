...
// PENTING: nama struct beda (AuthUser) supaya tidak tabrakan
...
func Login(c *gin.Context) {
    ...
    // 👇 TIDAK ADA kata 'password' di SELECT
    ...
    // bandingkan plaintext password dengan kolom password_hash
...
func Register(c *gin.Context) {
    ...
    // hash password ke kolom password_hash
